...
class PersonagemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create personagem" do
    assert_difference("Personagem.count") do
      post personagems_url, params: { personagem: { nivel: @personagem.nivel, nome: @personagem.nome } }, as: :json
    end
  ...
  test "should update personagem" do
    patch personagem_url(@personagem), params: { personagem: { nivel: @personagem.nivel, nome: @personagem.nome } }, as: :json
    assert_response :success
  end
